...
KW_BEGIN, KW_END, KW_INTEGER, KW_REAL, KW_BOOLEAN = \
    map(make_keyword, 'begin end integer real boolean'.split())
...
NProgram |= 'var', NVarDefs, KW_BEGIN, NStatements, KW_END, Program
