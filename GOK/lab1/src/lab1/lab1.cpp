...
static unsigned int lab1_bb_id(basic_block bb)
{
    ...
    FOR_EACH_EDGE(e, it, bb->succs) {dst_stream << e->dest->index << ", ";}
...
{   
    ...
    case SSA_NAME: {
        ...
        if (gimple_code(stmt) == GIMPLE_PHI) {
            std::cout << "(" << (SSA_NAME_IDENTIFIER(t) ? IDENTIFIER_POINTER(SSA_NAME_IDENTIFIER(t)) : "unkown") <<
...
unsigned int lab1_pass::execute(function*fn) { return lab1_function(fn); }
